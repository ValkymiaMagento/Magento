<?php 
class Collinsharper_Multistorepickup_Model_Carrier_ShippingMethod extends Mage_Shipping_Model_Carrier_Abstract
{ 

	protected $_code = 'chmultistorepickupmodule'; 
    ...
    public function getAllowedMethods()
    {
        ...
        foreach ($allowed as $k) {
            ...
            $customer_label = $this->getConfigData($k . '_title');
            $label = strlen($customer_label)  ? $customer_label  : 'Store ' . str_replace('chmpickup', '', $k);

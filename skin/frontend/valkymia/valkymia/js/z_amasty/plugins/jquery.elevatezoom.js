	...
	var ElevateZoom = {
		...
		$('.amasty-main-spinner').remove();
			...
			startZoom: function( ) {
				...
				self.zoomContainer = $('<div class="zoomContainer2" style="-webkit-transform: translateZ(0);position:absolute;left:'+self.nzOffset.left+'px;top:'+self.nzOffset.top+'px;"></div>');
				if($$('.zoomContainer2')[0]){
                    $$('.zoomContainer2')[0].remove();
                }
